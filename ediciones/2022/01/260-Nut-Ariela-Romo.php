...
<body>
  ...
  <article class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2022/01/260-Dr-Gerardo-Quintanar.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div class="ctc-bx">
            ...
            <?php include('../../../includes/ctc-romo-ree.php') ?>
          </div>
        </div>
      </aside>
    </div>
