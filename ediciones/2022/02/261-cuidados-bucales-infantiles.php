<style>
  ...
  <div class="contenedor m-0a nota-bx">
    <article class="col-64">
      ...
      <p class="f1 balazo-1">Cuidados bucales infantiles</p>
      <h1 class="f2 cabeza-1">Pequeñas sonrisas, enormes tesoros</h1>
      <p class="f1 sumario-1">Desde el nacimiento existen cuidados que hay que tener con la boquita de los bebés, saber qué corresponde a cada etapa es importante para procurar la salud bucal siempre</p>
      ...
      <div class="credito-bx">
        ...
        <p class="f1 credito-autor"><strong>Odont. Karla López Almazán</strong><br>Odontopediatría<br>
          <a href="mailto:karbere_21@hotmail.com"><i>karbere_21@hotmail.com</i></a>
        </p>
      </div>
