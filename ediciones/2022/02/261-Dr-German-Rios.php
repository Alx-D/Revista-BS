...
<body>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2022/02/261-Dr-Hector-Delgado.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="texto-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>Detectando la necesidad de recurso humano especializado en odontología, formado de manera local, y con una trayectoria de 50 años en odontología y ortodoncia, Germán Ríos Barceló fundó en 2012 Universidad ION.</p>
          <p>“Se buscaba poder brindar una educación de gran calidad del área de la odontología. Ya que detectamos la necesidad de atención odontológica de excelencia a la comunidad y, sobre todo, de atención en las diferentes especialidades de la odontología”, relató en entrevista con Revista BS Ríos Barceló.</p>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div id="espCtcBx">
            ...
            <?php include('../../../includes/ctc-rios-barcelo.php') ?>
          </div>
        </div>
      </aside>
    </div>
