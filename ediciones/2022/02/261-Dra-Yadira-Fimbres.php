...
<body>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2022/02/261-Dr-Alberto-Vazquez.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="txt-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>La especialista en odontopediatría habló de las complicaciones que puede conllevar un caso de caries mal atendida.</p>
          <p>“Puede ocasionar una infección, que es un proceso en el que la caries llega al nervio dental, se inflama el labio, el cachetito, hay veces que llegan hasta con el ojo cerrado por el proceso de infección”, alertó la especialista.</p>
          <p>Caída prematura del dientito, lo que a su vez podría acarrear que se pierda el espacio para el posterior diente permanente es otro de los problemas de caries que evolucionan.</p>
          <p>“Las funciones de los dientes de leche es mantener el espacio para los dientes permanentes, guiar su erupción”, detalló la experta, “sirven para la masticación, la fonación y, lógicamente, para la estética”.
