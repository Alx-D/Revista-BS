...
<?php include('includes/header-e258.php') ?>
  ...
  <div class="f1 migas">
      ...
      <a href="/ediciones/2021/11/258-Dr-Joel-Verdugo.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div class="ctc-bx">
            ...
            <?php include('../../../includes/ctc-puebla-zuniga.php') ?>
          </div>
        </div>
      </aside>
    </div>
