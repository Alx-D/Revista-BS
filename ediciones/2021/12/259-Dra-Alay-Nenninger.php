...
<?php include('includes/header-e259.php') ?>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2021/12/259-Dr-Joel-Verdugo.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="texto-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>“La pandemia este 2021 nos enseñó que lo más importante es la familia y, por supuesto, la salud, considero que es un año que nunca olvidaremos por todas las pérdidas, sin embargo, el hecho de incluir a las pacientes embarazadas en la vacunación contra el Covid-19 fue una importante arma para defendernos de desenlaces fatales”, expresó en charla con Revista BS la especialista.</p>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div id="espCtcBx">
            ...
            <?php include('../../../includes/ctc-nenninger-hoyos.php') ?>
          </div>
        </div>
      </aside>
    </div>
