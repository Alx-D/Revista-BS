...
<?php include('includes/header-e259.php') ?>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2021/12/259-Dra-Rosangela-Arellano.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="texto-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>“En las últimas décadas, el tratamiento para pacientes oncológicos en general ha avanzado considerablemente, buscando en su mayoría hacer medicina personalizada, y en el caso de pediatría, se ha mejorado notablemente el pronóstico del pequeño grupo de pacientes que resultan elegibles para dichos tratamientos”, subrayó la especialista en oncología pediátrica.</p>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div id="espCtcBx">
            ...
            <?php include('../../../includes/ctc-chavez-rede.php') ?>
          </div>
        </div>
      </aside>
    </div>
