...
<body>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2021/12/259-Dra-Dalila-Vasquez.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="texto-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>“Siempre va a ser un buen momento el inicio de un nuevo año para reflexionar y fomentar nuevas actitudes y nuevos hábitos que nos permitan tener una vida más saludable y próspera”, expresó en entrevista con Revista BS el profesional de la salud.</p>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div id="espCtcBx">
            ...
            <?php include('../../../includes/ctc-vizcaino-ahumada.php') ?>
