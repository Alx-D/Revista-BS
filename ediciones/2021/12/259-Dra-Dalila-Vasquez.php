...
<?php include('includes/header-e259.php') ?>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2021/12/259-Dr-Rafael-Inigo.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="texto-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>“Un avance muy importante en este 2021 fue la aparición de la vacuna Covid, y su aprobación para el uso en mujeres embarazadas, pues ya hay estudios que avalan su uso en esta etapa. Creo que es lo más destacado en el año porque con ella disminuimos la mortalidad materna, recordando que el Covid-19 ya es una de las tres principales causas de muerte materna”, comentó en charla con Revista BS la doctora <b>Dalila Vasquez Coronado</b>.</p>
