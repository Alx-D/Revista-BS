...
<?php include('includes/header-e259.php') ?>
  ...
  <article id="espNota" class="contenedor">
    <div class="f1 migas">
      ...
      <a href="/ediciones/2021/12/259-Dra-Elizabeth-Alvarez.php" style="margin-left: auto;"><i class="fa-solid fa-circle-arrow-right"></i>
      </a>
    </div>
    ...
    <div class="txt-bx">
      <div class="col-60">
        ...
        <div class="texto">
          ...
          <p>“Por efecto de la pandemia, uno de los logros más importantes en todas las especialidades fue la telemedicina, tanto para la capacitación de nosotros los médicos, como en la atención de los pacientes a distancia”, comentó en charla con Revista BS la doctora <b>Edita Gómez</b>.</p>
          <p>La también especialista en nutrición señaló además que otro efecto de la pandemia es el reconocimiento de la importancia del consumo diario de inmunonutrientes (zinc, proteínas, vitaminas C y D) para un excelente funcionamiento del sistema de defensas.</p>
          <p>El tiempo de confinamiento ha impactado la dinámica familiar, influyendo en la salud de los menores, la entrevistada destacó que la modificación de los hábitos alimenticios y la falta de actividad física han alterado el crecimiento en la mayoría de sus pacientes.</p>
      ...
      <aside class="col-40">
        ...
        <div class="col-40-row-2">
          ...
          <div id="espCtcBx">
            ...
            <?php include('../../../includes/ctc-gomez-paredes.php') ?>
          </div>
        </div>
      </aside>
    </div>
