  ...
  <main class="contenedor">
    <div class="pleca-alnz">
      ...
      <div class="f1 mobile">
        ...
        <div>
          <h3>Dr. José Antonio González Rincón</h3>
    ...
    <div class="foto-col">
      <div class="foto-bx">
        ...
        <div class="f1 agende">
          <a href="tel:+526622161492">Llame para agendar una cita 662 216-1492</a>
        </div>
      </div>
    </div>
    ...
    <div class="f1 contacto-bx">
      ...
      <p class="ctc-info"><i class="fas fa-map-marker-alt"></i> Blvd. Navarrete #97, esquina con Américas, <br>
        Hermosillo, Sonora</p>
